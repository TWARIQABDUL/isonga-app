...
const RegisterScreen = () => {
    ...
    return (
        <View className="flex-1 justify-center items-center bg-gradient-to-b from-purple-500 to-indigo-600 p-4 lg:h-screen">
            <View className="w-full max-w-md p-6 bg-white rounded-2xl fixed bottom-0 lg:static shadow-xl">
            {/* <View className="w-full max-w-md p-6 bg-white rounded-2xl shadow-xl fixed bottom-0 left-1/2 transform -translate-x-1/2 lg:static"> */}
